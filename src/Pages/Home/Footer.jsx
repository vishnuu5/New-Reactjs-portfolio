  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img className="nav-img-logo" src="./img/portfolio-logo.png" alt="Logoi" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/vishnu.athamakuru"
            ...
            <li>
              <a
                href="https://www.instagram.com/mr.unique543"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://mail.google.com/mail/u/0/vishnuathmakuru20@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/vishnuathmakuru"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by vishnu</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
